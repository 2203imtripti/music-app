...
public class Main1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speechRecognizer = SpeechRecognizer.createSpeechRecognizer(Main1Activity.this);
            ...
            public void onResults(Bundle bundle) {
                ...
                if(matchesFound != null)
                {
                    if(mode.equals("ON"))
                    {
                        ...
                        {
                            playPauseSong();
                            Toast.makeText(Main1Activity.this,"Command = "+keeper,Toast.LENGTH_LONG).show();
                        }
        ...
        voiceEnabledBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mode.equals("ON")){
                    mode="OFF";
                    voiceEnabledBtn.setText("Voice Enabled - OFF");
                    lowerRelativeLayout.setVisibility(View.VISIBLE);
                }
                else{
                    mode="ON";
                    voiceEnabledBtn.setText("Voice Enabled - ON");
    ...
    private void validateRecieveValuesAndStartPlaying()
    {
        ...
        myMediaPlayer = MediaPlayer.create(Main1Activity.this,uri);
        myMediaPlayer.start();
    ...
    private void checkVoiceCommandPermission(){
        if(Build.VERSION.SDK_INT>= Build.VERSION_CODES.M){
            if(!(ContextCompat.checkSelfPermission(Main1Activity.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED))
            {
